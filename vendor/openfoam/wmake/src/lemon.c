 ...
 * https://www.sqlite.org/src/artifact/3fdc16b23f1e
 * Artifact 3fdc16b23f1ea0c91c049b518fc3f75c71843dbfe2b447fcb3cd92d9e4f219f8:
 * File tool/lemon.c part of check-in [707c0f6442] at 2026-01-04
 */
/*
...
static void handle_e_option(char *z){
  code_ext = (char *) lemon_malloc( lemonStrlen(z)+2 );
  if( code_ext==0 ){
    fprintf(stderr,"out of memory\n");
    exit(1);
  }
